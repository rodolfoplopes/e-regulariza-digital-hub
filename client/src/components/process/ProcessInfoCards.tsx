...
export default function ProcessInfoCards({ process }: ProcessInfoCardsProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold break-words">{process.process_type?.name}</div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold break-words">{process.client?.name}</div>
        </CardContent>
      </Card>
    </div>
  );
