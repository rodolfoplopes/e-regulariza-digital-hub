  ...
  return <section className="py-16 bg-white">
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
        <div className="max-w-3xl mx-auto text-center mb-12">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Veja como funciona</h2>
          <p className="mt-4 text-lg text-gray-500">Um processo simplificado e transparente, do início ao fim.</p>
        </div>
          ...
          {steps.map((step, index) => <div key={index} className="relative">
              <div className="bg-white rounded-lg shadow-sm border p-6 h-full flex flex-col">
                <div className="flex items-center mb-4">
                  ...
                  {index < steps.length - 1 && <div className="hidden lg:block absolute left-full top-8 w-12 h-0.5 bg-gray-200 -ml-6 -mr-6 transform translate-x-1/2" />}
                </div>
